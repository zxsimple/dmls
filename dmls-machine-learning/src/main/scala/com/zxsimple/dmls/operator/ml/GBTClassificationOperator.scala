...
/**
  ...
  * 随机梯度提高分类模型
  */
class GBTClassificationOperator extends OperatorTemplate {
  /**
    * 验证参数
    *
    * @param properties
  ...
  /**
    ...
    * @return
    */
  def train(hc: HiveContext, processId: Long, nodeVertexInstanceId: String, properties: Properties, trainInputData: DataFrame): GradientBoostedTreesModel = {
  ...
  /**
    * 应用模型
    */
  def predict(hc: HiveContext, processId: Long, nodeVertexInstanceId: String, model: GradientBoostedTreesModel, properties: Properties, predictInputData: DataFrame) = {
