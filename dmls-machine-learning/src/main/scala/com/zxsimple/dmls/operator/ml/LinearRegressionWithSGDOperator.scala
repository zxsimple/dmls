...
/**
  ...
  * 线性回归模型
  */
class LinearRegressionWithSGDOperator extends OperatorTemplate {
  /**
    * 验证参数
    *
    * @param properties
  ...
  /**
    ...
    * @return
    */
  def train(hc: HiveContext, processId: Long, nodeVertexInstanceId: String, properties: Properties, trainInputData: DataFrame): LinearRegressionModel = {
    ...
    model = LinearRegressionWithSGD.train(trainData, numIterations, stepSize)
  ...
  /**
    * 应用模型
    */
  def predict(hc: HiveContext, processId: Long, nodeVertexInstanceId: String, model: LinearRegressionModel, properties: Properties, predictInputData: DataFrame) = {
